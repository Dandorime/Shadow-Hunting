...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(205, 495, 188, 77) action Start()
        hotspot(205, 572, 251, 87) action ShowMenu("load")
        hotspot(205, 657, 273, 87) action ShowMenu("preferences")
        hotspot(205, 744, 211, 88) action ShowMenu("about")
        hotspot(205, 832, 219, 85) action ShowMenu("help")
        hotspot(205, 917, 175, 85) action Quit(confirm=True)
